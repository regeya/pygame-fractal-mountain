        ...
        for y in range(0, 64):
            ...
            for x in range(0, 64):
                if self.lv[x + 1][y + 1] < 0:
                    self.lv[x + 1][y + 1] = 0
                self.llv = int(self.lv[x][y] + self.lv[x + 1][y] + self.lv[x][y + 1])
                self.llv = int((self.llv + self.lv[x + 1][y + 1]) / 4)
                a = x
                b = y
                ...
                pygame.gfxdraw.filled_polygon(
                    self.surf, ((rx, ry), (rx1, ry1), (rx2, ry2)), shade1
                )
                pygame.gfxdraw.filled_polygon(
                    self.surf, ((rx, ry), (rx2, ry2), (rx4, ry4)), shade2
                )
                pygame.gfxdraw.filled_polygon(
                    self.surf, ((rx, ry), (rx1, ry1), (rx3, ry3)), shade3
                )
                pygame.gfxdraw.filled_polygon(
                    self.surf, ((rx, ry), (rx3, ry3), (rx4, ry4)), shade4
                )
